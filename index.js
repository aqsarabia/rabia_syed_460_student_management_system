...
const main = async () => {
    ...
    switch (choice) {
        ...
        case "Update Student":
            ...
            const studentToUpdate = studentInfo.find((student) => student.studentId === studentId);
            if (studentToUpdate) {
        ...
        case "Add Balance":
            ...
            const studentToAddBalance = studentInfo.find((student) => student.studentId === addBanalceStudentId);
        ...
        case "Show Status":
            ...
            const showStatusOfStudend = studentInfo.find((student) => student.studentId === showStatusStudentId);
